...
urlpatterns = patterns('',
    ...
    url(r'^sampleReport1/', 'sysMo.views.sampleReport1', name='sampleReport1'),
    url(r'^sampleReport2/', 'sysMo.views.sampleReport2', name='sampleReport2'),
    url(r'^sampleReport3/', 'sysMo.views.sampleReport3', name='sampleReport3'),
